...
window.location.href='./index.php'; </script>";
    ...
    ?>
 // This is for conection of the between the databases and the website
    ...
    <tbody>
        ...
        ?>
//php is for creating a new user registration 
    </tbody>
 </table>
...
<?php 
 ...
 <?php 
    ...
    <tbody>
        ...
        ?>
//selecting new user with their respective roles
    </tbody>
 </table>
